...
|  |  |  |
|:---------------------:|:----------------------:|:------------------------:|
| **Assists (8.06 x 10^-5^)** | **True Shooting % (1.14 x 10^-4^)** | Offensive Rebounds (1.79 x 10^-3^) |
| Player Efficiency (0.67) | **3PT Attempts (0.02)** | **Offensive Rating (0.01)** |
| Value Over Replacement (0.07) | **Free Throw Attempts (0.05)** | Defensive Rating (0.16) |
| Win Shares (0.75) | Total Rebound % (0.57) | 3PT Shooting (0.09) |
| **Turnover % (0.03)** | **Personal Fouls (4.41 x 10^-3^)** | **Field Goal % (1.36 x 10^-3^)** |
